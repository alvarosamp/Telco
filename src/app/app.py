...
#nsure we can import from sc;serving when running "uvicorn srsc.data.app.app:app"
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../../..")))

from serving.inference import predict #our sing le source for the inference logic
...
@app.post("/predict")
def api_predict(data: CustumerData):
    try:
